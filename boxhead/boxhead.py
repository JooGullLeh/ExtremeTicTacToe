...
class Blood(object):
    ...
    def __init__(self,x,y):
        ...
        self.image = PhotoImage(file = "game_elements/blood.gif")
...
class MINE(object):
    ...
    def __init__(self,x,y):
        self.photo = PhotoImage(file = "game_elements/mine.gif")
...
class Zombie_Attack(object):
    ...
    def __init__(self,x,y,x_vel,y_vel):
        self.x = x
        self.y = y
        self.image = PhotoImage(file = "game_elements/devil_a.gif")
...
class Boxhead(object):
    ...
    def __init__(self):
        self.image_up = PhotoImage(file = "boxhead/bhup.gif") # The image changes if Boxhead is facing up down left right
        self.image_down = PhotoImage(file = "boxhead/bhdown.gif")
        self.image_left = PhotoImage(file = "boxhead/bhleft.gif")
        self.image_right = PhotoImage(file = "boxhead/bhright.gif")
...
class Zombie(object):
    ...
    def __init__(self):
        self.zup = PhotoImage(file = "zombies/zup.gif") # there are 8 directions that Zombies can move in
        self.zdown = PhotoImage(file = "zombies/zdown.gif")
        self.zleft = PhotoImage(file = "zombies/zleft.gif")
        self.zright = PhotoImage(file = "zombies/zright.gif")
        self.zrightup = PhotoImage(file = "zombies/zrightup.gif")
        self.zrightdown = PhotoImage(file = "zombies/zrightdown.gif")
        self.zleftup = PhotoImage(file = "zombies/zleftup.gif")
        self.zleftdown = PhotoImage(file = "zombies/zleftdown.gif")
...
class Devil(object):
    ...
    def __init__(self):
        ...
        self.attack_fire = 0
        self.health = 100
        self.dup = PhotoImage(file = "devils/du.gif") # the 8 Devil images
        self.ddown = PhotoImage(file = "devils/db.gif")
        self.dleft = PhotoImage(file = "devils/dl.gif")
        self.dright = PhotoImage(file = "devils/dr.gif")
        self.drightup = PhotoImage(file = "devils/dtr.gif")
        self.drightdown = PhotoImage(file = "devils/dbr.gif")
        self.dleftup = PhotoImage(file = "devils/dtl.gif")
        self.dleftdown = PhotoImage(file = "devils/dbl.gif")
